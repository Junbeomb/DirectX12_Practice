...
D3D12_RASTERIZER_DESC Shader::CreateRasterizerState()
{
	...
	d3dRasterizerDesc.CullMode = D3D12_CULL_MODE_BACK; //은면 컬링
...
void Shader::CreateShader(ID3D12Device* pd3dDevice, ID3D12RootSignature
...
{
	return(Shader::CompileShaderFromFile(const_cast<WCHAR*>(L"Shaders.hlsl"), "VSDiffused", "vs_5_1",
		ppd3dShaderBlob));
}
D3D12_SHADER_BYTECODE DiffusedShader::CreatePixelShader(ID3DBlob** ppd3dShaderBlob)
{
	return(Shader::CompileShaderFromFile(const_cast<WCHAR*>(L"Shaders.hlsl"), "PSDiffused", "ps_5_1",
		ppd3dShaderBlob));
}
